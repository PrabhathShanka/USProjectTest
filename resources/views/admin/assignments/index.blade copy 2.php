                 ...
                 <div class="flex justify-between">
                     ...
                     <div class="flex flex-col items-start text-sm text-gray-500 mb-4">
                         <div class="contact-badge mr-2">
                             ...
                             <i class="fa fa-superpowers mr-1"></i> Others
                         </div>
                 ...
                 <div class="flex justify-between items-center">
                     <div>
                         @if ($assignment->promotionCode)
                            ...
                            @endphp
                            <span class="text-lg font-bold text-indigo-600">{{ number_format($finalPrice, 2) }}</span>
                            <span class="text-sm text-gray-500 line-through ml-2">{{ number_format($assignment->price, 2) }}</span>
                            <span class="discount-badge mr-2">
                                <i class="fas fa-tag mr-1"></i>
                            </span>
                            <span class="text-green-600 font-medium">{{ $discount }}% off</span>
                         @endif
                     </div>
