    ...
    <header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll': stickyMenu }"
        ...
        <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
            <div class="vd to/4 tc wf yf">
                <a href="index.html">
                    <img class="om" src="{{ Vite::asset('resources/images/landingPage/logo-light.svg') }}"
                        alt="Logo Light" />
                    <img class="xc nm" src="{{ Vite::asset('resources/images/landingPage/logo-dark.svg') }}"
                        alt="Logo Dark" />
                </a>
            ...
            <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
                <!-- Temporary solution until routes are defined -->
                <nav>
                    <ul class="tc _o sf yo cg ep">
                        <li><a href="{{ url('/') }}" class="xl" :class="{ 'mk': page === 'home' }">Home</a>
                        </li>
                        ...
                        <li class="c i" x-data="{ dropdown: false }">
                            ...
                            <ul class="a" :class="{ 'tc': dropdown }">
                                <li><a href="{{ url('/blog') }}" class="xl"
                                        :class="{ 'mk': page === 'blog-grid' }">Blog Grid</a></li>
                                <li><a href="{{ url('/blog/single') }}" class="xl"
                                        :class="{ 'mk': page === 'blog-single' }">Blog Single</a></li>
                                <li><a href="{{ url('/login') }}" class="xl"
                                        :class="{ 'mk': page === 'signin' }">Sign
                                        In</a></li>
                                <li><a href="{{ url('/register') }}" class="xl"
                                        :class="{ 'mk': page === 'signup' }">Sign
                                        Up</a></li>
                                <li><a href="{{ url('/404') }}" class="xl"
                                        :class="{ 'mk': page === '404' }">404</a>
                                </li>
                            </ul>
                            <!-- Dropdown End -->
                        </li>
                ...
                <div class="tc wf ig pb no">
                    <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
                        <label class="rc ab i">
                            ...
                            <!-- Icon Sun -->
                            <img class="xc nm" src="{{ Vite::asset('resources/images/landingPage/icon-moon.svg') }}"
                                alt="Moon" />
                        </label>
                    </div>
    ...
    <main>
        ...
        <section class="gj do ir hj sp jr i pg">
            ...
            <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
                ...
                <img src="{{ Vite::asset('resources/images/landingPage/shape-04.svg') }}" alt="shape"
                    class="h q r" />
                <img src="{{ Vite::asset('resources/images/landingPage/hero.png') }}" alt="Woman"
                    class="h q r ua" />
            </div>
                ...
                <div class="tc uf zo xf ap zf bp mq">
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg mh">
                            <img src="{{ Vite::asset('resources/images/landingPage/icon-01.svg') }}"
                                alt="Icon" />
                        </div>
                        <div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg nh">
                            <img src="{{ Vite::asset('resources/images/landingPage/icon-02.svg') }}"
                                alt="Icon" />
                        </div>
                        <div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg oh">
                            <img src="{{ Vite::asset('resources/images/landingPage/icon-03.svg') }}"
                                alt="Icon" />
                        </div>
                        <div>
                    ...
                    <div class="animate_left xc gn gg jn/2 i">
                        <div>
                            ...
                            <img src="{{ Vite::asset('resources/images/landingPage/about-01.png') }}" alt="About"
                                class="ib" />
                            <img src="{{ Vite::asset('resources/images/landingPage/about-02.png') }}"
                                alt="About" />
                        </div>
                        <div>
                            <img src="{{ Vite::asset('resources/images/landingPage/shape-06.svg') }}"
                                alt="Shape" />
        ...
        <section class="i pg ji gp uq">
            ...
            <img src="{{ Vite::asset('resources/images/landingPage/shape-08.svg') }}" alt="Shape Bg"
                class="h q r" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-09.svg') }}" alt="Shape"
                class="of h y z/2" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-10.svg') }}" alt="Shape"
                class="h _ aa" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-11.svg') }}" alt="Shape"
                class="of h m ba" />
        ...
        <section x-data="setup()" class="i pg fh rm ji gp uq">
            ...
            <img src="{{ Vite::asset('resources/images/landingPage/shape-07.svg') }}" alt="Shape"
                class="h w da ee" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-12.svg') }}" alt="Shape"
                class="h p s" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-13.svg') }}" alt="Shape"
                class="h r q" />
                ...
                <div class="projects-wrapper tc -ud-mx-5">
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="{{ Vite::asset('resources/images/landingPage/project-01.png') }}"
                                alt="Project" />
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 digital">
                        <div class="c i pg sg z-1">
                            <img src="{{ Vite::asset('resources/images/landingPage/project-02.png') }}"
                                alt="Project" />
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="{{ Vite::asset('resources/images/landingPage/project-04.png') }}"
                                alt="Project" />
                    ...
                    <div class="project-item wi fb vd vo/3 digital ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="{{ Vite::asset('resources/images/landingPage/project-03.png') }}"
                                alt="Project" />
        ...
        <section class="i pg qh rm ji hp">
            ...
            <img src="{{ Vite::asset('resources/images/landingPage/shape-07.svg') }}" alt="Shape"
                class="h ia o ae jf" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-14.svg') }}" alt="Shape"
                class="h ja ka" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-15.svg') }}" alt="Shape"
                class="h q p" />
                ...
                <div class="wc rf qn zf cp kq xf wf">
                    <a href="#!" class="rc animate_top">
                        <img class="th wl ml il zl om"
                            src="{{ Vite::asset('resources/images/landingPage/brand-light-01.svg') }}"
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-01.svg') }}"
                            alt="Clients" />
                    </a>
                    <a href="#!" class="rc animate_top">
                        <img class="tk ml il zl om"
                            ...
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-02.svg') }}"
                            alt="Clients" />
                    </a>
                    <a href="#!" class="rc animate_top">
                        <img class="tk ml il zl om"
                            src="{{ Vite::asset('resources/images/landingPage/brand-light-03.svg') }}"
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-03.svg') }}"
                            alt="Clients" />
                    </a>
                    <a href="#!" class="rc animate_top">
                        <img class="tk ml il zl om"
                            src="{{ Vite::asset('resources/images/landingPage/brand-light-04.svg') }}"
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-04.svg') }}"
                            alt="Clients" />
                    </a>
                    <a href="#!" class="rc animate_top">
                        <img class="tk ml il zl om"
                            src="{{ Vite::asset('resources/images/landingPage/brand-light-05.svg') }}"
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-05.svg') }}"
                            alt="Clients" />
                    </a>
                    <a href="#!" class="rc animate_top">
                        <img class="tk ml il zl om"
                            src="{{ Vite::asset('resources/images/landingPage/brand-light-06.svg') }}"
                            alt="Clients" />
                        <img class="xc sk ml il zl nm"
                            src="{{ Vite::asset('resources/images/landingPage/brand-dark-06.svg') }}"
                            alt="Clients" />
                    </a>
                </div>
            </div>
        ...
        <section class="i pg gh ji">
            <!-- Bg Shape -->
            <img class="h p q" src="{{ Vite::asset('resources/images/landingPage/shape-16.svg') }}"
                alt="Bg Shape" />
            ...
            <div class="ji gp">
                <div class="tc uf ap gg fp">
                    <div class="animate_top zd/2 to/4">
                        <a href="index.html">
                            <img src="{{ Vite::asset('resources/images/landingPage/logo-light.svg') }}') }}"
                                alt="Logo" class="om" />
                            <img src="{{ Vite::asset('resources/images/landingPage/logo-dark.svg') }}') }}"
