...
@section('meta_description', 'CodeCrew provides professional assignment and project completion services for Sri Lankan
...
<main>
    ...
    <section class="gj do ir hj sp jr i pg">
        ...
        <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
            <img src="{{ Vite::asset('resources/images/landingPage/shape-01.svg') }}" alt="shape"
                class="xc 2xl:ud-block h t -ud-left-[10%] ua" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-02.svg') }}" alt="shape"
                class="xc 2xl:ud-block h u p va" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-03.svg') }}" alt="shape"
                class="xc 2xl:ud-block h v w va" />
            <img src="{{ Vite::asset('resources/images/landingPage/shape-04.svg') }}" alt="shape" class="h q r" />
            <img src="{{ Vite::asset('resources/images/landingPage/hero.png') }}" alt="Woman" class="h q r ua" />
        </div>
        ...
        <div class="bb ze ki xn wq">
            <div class="tc wf gg qq">
                ...
                <div class="animate_left xc gn gg jn/2 i">
                    <div>
                        <img src="{{ Vite::asset('resources/images/landingPage/shape-05.svg') }}" alt="Shape"
                            class="h -ud-left-5 x" />
                        <img src="{{ Vite::asset('resources/images/landingPage/about-01.png') }}" alt="About"
                            class="ib" />
                        <img src="{{ Vite::asset('resources/images/landingPage/about-02.png') }}" alt="About" />
                    </div>
                    <div>
                        <img src="{{ Vite::asset('resources/images/landingPage/shape-06.svg') }}" alt="Shape" />
                        <img src="{{ Vite::asset('resources/images/landingPage/about-03.png') }}" alt="About"
                            class="ob gb" />
                        <img src="{{ Vite::asset('resources/images/landingPage/shape-07.svg') }}" alt="Shape"
                            class="bb" />
                    </div>
                </div>
                ...
                <div class="animate_right jn/2">
                    ...
                    <a href="https://www.youtube.com/watch?v=xcJtL7QggTI" data-fslightbox class="vc wf hg mb">
                        <span class="tc wf xf be dd rg i gh ua">
                            ...
                            <img src="{{ Vite::asset('resources/images/landingPage/icon-play.svg') }}" alt="Play" />
                        </span>
    ...
    <section class="i pg ji gp uq">
        ...
        <img src="{{ Vite::asset('resources/images/landingPage/shape-08.svg') }}" alt="Shape Bg" class="h q r" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-09.svg') }}" alt="Shape" class="of h y z/2" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-10.svg') }}" alt="Shape" class="h _ aa" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-11.svg') }}" alt="Shape" class="of h m ba" />

        <!-- Section Title Start -->
        <div
            x-data="{ sectionTitle: `Meet Our Academic Excellence Team`, sectionTitleText: `Our dedicated team of academic professionals and subject matter experts are committed to delivering high-quality assignment solutions that help Sri Lankan students achieve their academic goals.` }">
            ...
            <div class="wc qf pn xo gg cp">
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ Vite::asset('resources/images/landingPage/team-01.png') }}"
                            alt="Team" />
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ Vite::asset('resources/images/landingPage/team-02.png') }}"
                            alt="Team" />
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ Vite::asset('resources/images/landingPage/team-03.png') }}"
                            alt="Team" />
    ...
    <section class="lj tp kr">
        <!-- Section Title Start -->
        <div
            x-data="{ sectionTitle: `Comprehensive Academic Services for University Students`, sectionTitleText: `We provide a wide range of academic support services tailored to meet the diverse needs of Sri Lankan university students across all disciplines and academic levels.` }">
            <div class="animate_top bb ze rj ki xn vq">
                <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                </h2>
                <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
    ...
    <section x-data="setup()" class="i pg fh rm ji gp uq">
        <!-- Bg Shapes -->
        <img src="{{ Vite::asset('resources/images/landingPage/shape-06.svg') }}" alt="Shape" class="h aa y" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-03.svg') }}" alt="Shape" class="h ca u" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-07.svg') }}" alt="Shape" class="h w da ee" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-12.svg') }}" alt="Shape" class="h p s" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-13.svg') }}" alt="Shape" class="h r q" />

        <!-- Section Title Start -->
        <div
            x-data="{ sectionTitle: `Affordable Academic Support Packages for Students`, sectionTitleText: `Choose from our flexible pricing plans designed specifically for Sri Lankan university students. We offer competitive rates with payment options that fit your student budget.` }">
            <div class="animate_top bb ze rj ki xn vq">
                <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                </h2>
                <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
                        ...
                        <div class="swiper-slide">
                            <div class="i hh rm sg vk xm bi qj">
                                ...
                                <div class="tc sf rn tn un zf dp">
                                    <img class="bf"
                                        src="{{ Vite::asset('resources/images/landingPage/testimonial.png') }}"
                                        alt="User" />
                                    ...
                                    <div>
                                        ...
                                        <div class="tc yf vf">
                                            <div>
                                                ...
                                                <span class="rc">Computer Science Graduate @University of Colombo</span>
                                            </div>

                                            <img class="rk"
                                                src="{{ Vite::asset('resources/images/landingPage/brand-light-02.svg') }}"
                                                alt="Brand" />
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="i pg qh rm ji hp">
        <img src="{{ Vite::asset('resources/images/landingPage/shape-11.svg') }}" alt="Shape" class="of h ga ha ke" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-07.svg') }}" alt="Shape" class="h ia o ae jf" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-14.svg') }}" alt="Shape" class="h ja ka" />
        <img src="{{ Vite::asset('resources/images/landingPage/shape-15.svg') }}" alt="Shape" class="h q p" />
    ...
    <section class="pj vp mr">
        <!-- Section Title Start -->
        <div
            x-data="{ sectionTitle: `Trusted by Students from Leading Universities`, sectionTitleText: `We proudly serve students from top universities across Sri Lanka, helping them achieve academic excellence with our professional assignment and project support services.` }">
            <div class="animate_top bb ze rj ki xn vq">
                <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
                </h2>
                <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
            ...
            <div class="wc rf qn zf cp kq xf wf">
                <a href="#!" class="rc animate_top">
                    <img class="th wl ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-01.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-01.svg') }}" alt="Clients" />
                </a>
                <a href="#!" class="rc animate_top">
                    <img class="tk ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-02.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-02.svg') }}" alt="Clients" />
                </a>
                <a href="#!" class="rc animate_top">
                    <img class="tk ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-03.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-03.svg') }}" alt="Clients" />
                </a>
                <a href="#!" class="rc animate_top">
                    <img class="tk ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-04.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-04.svg') }}" alt="Clients" />
                </a>
                <a href="#!" class="rc animate_top">
                    <img class="tk ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-05.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-05.svg') }}" alt="Clients" />
                </a>
                <a href="#!" class="rc animate_top">
                    <img class="tk ml il zl om"
                        src="{{ Vite::asset('resources/images/landingPage/brand-light-06.svg') }}" alt="Clients" />
                    <img class="xc sk ml il zl nm"
                        src="{{ Vite::asset('resources/images/landingPage/brand-dark-06.svg') }}" alt="Clients" />
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="i pg gh ji">
        <!-- Bg Shape -->
        <img class="h p q" src="{{ Vite::asset('resources/images/landingPage/shape-16.svg') }}" alt="Bg Shape" />
