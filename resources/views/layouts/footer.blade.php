...
<footer>
    <div class="bb ze ki xn 2xl:ud-px-0">
        ...
        <div class="ji gp">
            <div class="tc uf ap gg fp">
                <div class="animate_top zd/2 to/4">
                    <a href="index.html">
                        <img src="{{ Vite::asset('resources/images/landingPage/logo-light.svg') }}" alt="Logo"
                            class="om" />
                        <img src="{{ Vite::asset('resources/images/landingPage/logo-dark.svg') }}" alt="Logo"
                            class="xc nm" />
                    </a>

                    <p class="lc fb">Professional assignment and project completion services for Sri Lankan university
                        students. Excellence in academic support with guaranteed quality and timely delivery.</p>
                ...
                <div class="vd ro tc sf rn un gg vn">
                    <div class="animate_top">
                        ...
                        <ul>
                            ...
                            <li><a href="#!" class="sc xl vb">Our Services</a></li>
                            <li>
                    ...
                    <div class="animate_top">
                        <h4 class="kk wm tj ec">Academic Services</h4>

                        <ul>
                            <li><a href="#!" class="sc xl vb">Assignment Writing</a></li>
                            <li><a href="#!" class="sc xl vb">Research Papers</a></li>
                            <li><a href="#!" class="sc xl vb">Coding Projects</a></li>
                            <li><a href="#!" class="sc xl vb">Final Year Projects</a></li>
                        </ul>
                    </div>

                    <div class="animate_top">
                        <h4 class="kk wm tj ec">Student Support</h4>

                        <ul>
                            <li><a href="#!" class="sc xl vb">About CodeCrew</a></li>
                            <li><a href="#!" class="sc xl vb">Student Reviews</a></li>
                            <li><a href="#!" class="sc xl vb">FAQ</a></li>
                            <li><a href="#!" class="sc xl vb">Contact Us</a></li>
                        </ul>
                    </div>

                    <div class="animate_top">
                        <h4 class="kk wm tj ec">Stay Updated</h4>
                        <p class="ac qe">Get academic tips, deadline reminders, and special offers for students</p>
        ...
        <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
            <div class="animate_top">
                <ul class="tc wf gg">
                    <li><a href="#!" class="xl">Terms of Service</a></li>
                    <li><a href="#!" class="xl">Privacy Policy</a></li>
                    <li><a href="#!" class="xl">Academic Integrity</a></li>
                    <li><a href="#!" class="xl">Support</a></li>
                </ul>
            </div>

            <div class="animate_top">
                <p>&copy; 2025 CodeCrew. All rights reserved. Professional Academic Support Services for Sri Lankan
                    Students.</p>
            </div>
        </div>
        <!-- Footer Bottom -->
