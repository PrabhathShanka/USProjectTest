            ...
            <ul class="tc _o sf yo cg ep">
                ...
                <li class="c i" x-data="{ dropdown: false }">
                    ...
                    <ul class="a" :class="{ 'tc': dropdown }">
                        <li><a href="{{ url('/blog') }}" class="xl" :class="{ 'mk': page === 'blog-grid' }">Blog
                                Grid</a></li>
                        <li><a href="{{ url('/blog/single') }}" class="xl"
                                :class="{ 'mk': page === 'blog-single' }">Blog Single</a></li>
                        <li><a href="{{ url('/login') }}" class="xl" :class="{ 'mk': page === 'signin' }">Sign
                                In</a></li>
                        <li><a href="{{ url('/register') }}" class="xl" :class="{ 'mk': page === 'signup' }">Sign
                                Up</a></li>
                        <li><a href="{{ url('/404') }}" class="xl" :class="{ 'mk': page === '404' }">404</a>
                        </li>
                    </ul>
                    <!-- Dropdown End -->
                </li>
